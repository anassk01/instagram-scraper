...
function extractProfile() {
    ...
    try {
        ...
        const profileImg = document.querySelector('img[alt*="profile picture"]') as HTMLImageElement;
        ...
        // External link
        const linkElement = document.querySelector('a[href^="https://l.instagram.com"]') as HTMLAnchorElement;
        if (linkElement) {
